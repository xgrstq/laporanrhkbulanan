...
export default function Navbar({ page, setPage }) {
  ...
  const handleExportPDF = () => {
    ...
    if (!element) return alert("Buka halaman Lihat dulu")

    const opt = {
      margin: 0.5,
      filename: "Laporan-PKH.pdf",
  ...
  return (
    <>
      ...
      <div className="hidden md:flex fixed top-6 left-1/2 -translate-x-1/2 z-50">
        <div className="flex items-center gap-10 bg-white shadow-xl border px-10 py-4 rounded-full">
          ...
          <button
            ...
            className="flex items-center gap-2 text-green-700 font-medium hover:scale-105 transition"
          >
            <FiDownload />
            PDF
          </button>
